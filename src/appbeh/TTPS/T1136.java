...
public class T1136 extends TTP {
	public void signatureScore(ArrayList<ArrayList<String>> targetFile) {
		...
		System.out.println("T1136:   "+score);
	}
	...
	public int signatureMatching(ArrayList<String> oneLine) {
		if (oneLine.get(0).equals("File:")) { 
			...
			String pattern1 = "(login.defs|nsswitch.conf|shadow)";
			Pattern p1 = Pattern.compile(pattern1);  
			Matcher m1 = p1.matcher(basename); 
			
			String pattern2 = "(passwd|group|gshadow)";
			...
			if (oneLine.get(3).equals("read") && (m1.matches())) {
				return 1;
			}
			
			if (oneLine.get(3).equals("write") && (m2.matches())) {
				return 1;
			}
